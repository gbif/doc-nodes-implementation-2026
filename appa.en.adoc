...
Master graduates will achieve their research works using GBIF data to provide evidence for decision making on biodiversity conservation and sustainable use in the context of climate and global changes.
...
Training workshops will be organized by GBIF Benin to enhance capacity of some national partners to support data mobilization and publication on GBIF site.
...
We plan to contribute to new model use to publish data whenever possible.
...
* ECCC to further develop  real-time data products leveraging APIs to serve research, policy, and public needs (e.g., biodiversity dashboards, KBA tools).
* Internal Government of Canada infrastructure upgrades for increased data throughput, quality, and security, supporting both FAIR and CARE principles.
* Increase automation and use of AI for data cleaning, species identification, e.g., camera trap image recognition, Automated Recording Units), and validation.
* Continued leadership on international data standards, interoperability, and open science infrastructure (e.g., https://www.canada.ca/en/government/system/digital-government/leveraging-information-data/annual-report-2023-2026-data-strategy.html and https://science.gc.ca/site/science/en/office-chief-science-advisor/open-science/data-governance/towards-national-scientific-data-governance-framework) and participation in Task Groups and leadership in Biodiversity Information Standards (TDWG).
* Publish more regionally- and taxonomically-focused checklists similar to that of the recently published Nematodes of Canada, https://doi.org/10.5886/gbcnv7 
