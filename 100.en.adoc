...
* Engage with scientific leaders in biodiversity sciences to build and develop a scientific community around the node. The https://www.gbif.org/resource/search?contentType=literature&literatureType=journal&relevance=GBIF_USED&peerReview=true[country filter^] of literature tracking and annual https://www.gbif.org/science-review[_Science Review#_] can help identify active users of GBIF-mediated data in the country.
